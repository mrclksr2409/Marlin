...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN FAN4_PIN        // Set a custom pin for the controller fan
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  30, 30 }, { 30,  320 }, { 320, 320 }, { 320, 30 } }
  ...
  //#define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_STEPPER_XY { { -50, 102.5 }, { 152.6, 220.0 }, { 94.5, 102.5 }, { 94.5, 102.5 } }
  #else
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  // Add Probe Z Offset calibration to the Z Probe Offsets menu
    ...
    #define PROBE_OFFSET_WIZARD
      ...
      #define PROBE_OFFSET_WIZARD_XY_POS { 175, 175 }
    #endif
  #endif
