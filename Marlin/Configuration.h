...
#define CUSTOM_MACHINE_NAME "Voron 2.4"
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1200, 1200, 1200, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 25, -1.53 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  30, 350, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 60, 350, (Z_MIN_POS + 1) } }
